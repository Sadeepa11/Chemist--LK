                        ...
                        <div class="row g-0" >
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <a class=" btn btn-outline-danger " onclick='deleteVideo(<?php echo $video_data["id"] ?>);'>Delete This</a>
                                    <!-- <a class=" btn btn-outline-danger " onclick='modelUV(<?php echo $video_data["id"] ?>);'>Delete This</a> -->
                                    <!-- <a class=" btn btn-outline-danger " href= <?php echo "deleteVideo.php?id=" . ($video_data["id"]); ?>>Delete This</a> -->
                                </div>
                            </div>
                        </div>
                    </div>
